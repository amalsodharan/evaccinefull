...
<body>
    ...
    <center>
        <br><br>
        <h2 style="color: white;font-size: 40px;">ADMIN USER ACCOUNT</h2>
        <div class="imo">
        <img src="logo.svg" height="130px" width="130px" style="padding-bottom: 8px;">
        </div><br>
        <div class="content"><br><br>
                <form action="adminaddb.php" method="post">
                    <input type="text" placeholder="Enter Your Name" class="bar" name="name" required><br><br><br>
                    <input type="text" placeholder="Mobile Number or Email id" class="bar" name="mobile" required><br><br><br>
                    <input type="text" placeholder="Enter Your Username" class="bar" name="username" required><br><br><br>
                    <input type="password" placeholder="New Password" class="bar" name="password" required><br><br><br>
                    <input type="date" class="bar" name="dob" required><br><br><br>
                    <input type="number" placeholder="Enter Your Age" class="bar" name="age" required><br><br>
                    <label class="fld" style="color: blueviolet"><b>Gender</b></label><br>
