...
<header>
    ...
    <div class="mid"><br><br>
        <h2 style="color: white;font-size: 35px;text-align: center">USER APPOINTMENTS</h2>
    <br><br>
    ...
    $query = "SELECT * FROM bookinfo"; // Replace 'appointments_table' with your actual table name
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tbody><tr><td colspan='3'>No appointments found</td></tr></tbody>";
    }
    ...
    <div class="row">
        ...
        <div class="col"><br><br><br><br>
            <h4 style="font-size: 18px;color: white;"><i>Vaccines are the tugboats of preventive health. <br>-William Foege</i></h4>
        </div>
    </div>
    <br><br><br>
    </div>
